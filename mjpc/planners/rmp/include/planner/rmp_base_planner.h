...
class RMPPlannerBase : public mjpc::Planner {
 public:
  ...
  ~RMPPlannerBase() override = default;
  ...
  virtual double distanceToObstacle(const VectorQ& pos) { return 0; }

  virtual VectorQ gradientToObstacle(const VectorQ& pos) { return VectorQ::Zero(); }
