...
public:
   ...
   */
  WarmStart(const int num_steps, const Diagram<double>& diagram, const MultibodyPlant<double>& plant,
            const int num_eq_constraints, const std::vector<VectorXd> q_guess, const double Delta0)
