...
#include "mjpc/planners/idto/optimizer/convergence_criteria_tolerances.h"
...
struct IdtoPlannerConfig {
  ...
  idto::optimizer::ConvergenceCriteriaTolerances tolerances;
...
using IdtoPlannerConfigPtr = std::shared_ptr<IdtoPlannerConfig>;
