...
public:
  FabParameterizedPlaneConstraintMap(FabVariables vars, const CaSX& fk, const CaSX& constraint_var,
    ...
    : FabParameterizedGeometryMap(CaSX::abs(CaSX::dot(fab_core::get_casx(constraint_var,
                                                        std::array<casadi_int, 2>{0, 3}), fk) +
                                            fab_core::get_casx(constraint_var, 3)) /
                                  CaSX::norm_2(
                                      fab_core::get_casx(constraint_var, std::array<casadi_int, 2>{0, 3})) -
                                  radius_body_var,
                                  std::move(vars)) {
  }
};
