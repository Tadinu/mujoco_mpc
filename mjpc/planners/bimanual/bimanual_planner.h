...
namespace mjpc
{
  ...
  private:
    ...
    std::vector<Obstacle> obstacles_ = {
      Obstacle("obs1", {-0.2, 0.0, 0.9}, {0.0, -0.0, 0.04}, 0.2),
    ...
    Vector7d q_goal_left_ = {
               -1.4219862916805648, 0.9526660423399979, 0.2692655194467807, -1.379018012046814,
               -0.0431369121770064, 2.612734319819344, 0.36745211305883196
             },
             q_goal_right_ = {
               0.27823671439013664, 0.5812998044484216, -0.4581389926175737, -0.8199389611129149,
  ...
  public:
    ...
    void Initialize(mjModel* model, const Task& task) override
    {
      ...
      dim_max_ = std::max({dim_state_, dim_state_derivative_, action_dim_, int(model->nuser_sensor)});
