...
GraspState GetGraspState(const mjModel* m, const mjData* d, const ModelValues& model_vals, int body_id) {
  ...
  int ray_geom_id;
  double ray_distance = mj_ray(m, d, right_finger, direction, geomgroup, 0, -1, &ray_geom_id);
  ...
  double ray_distance2 = mj_ray(m, d, left_finger, direction, geomgroup, 0, -1, &ray_geom_id);
...
double BlockedCost(const mjModel* model, const mjData* data, const ModelValues& model_vals, const double* pos,
  ...
  int ray_geom_id;
  double ray_distance = mj_ray(model, data, pos, direction, geomgroup, 0, exclude_body_id, &ray_geom_id);
