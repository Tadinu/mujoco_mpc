...
namespace mjpc {
class ParticleX : public Task {
public:
  ParticleX() : residual_(this) {
  ...
  public:
    ...
    const ParticleX* particle_task = nullptr;
  };
...
class ParticleXFixed : public ParticleX {
public:
  ParticleXFixed() : residual_(this) {
  ...
  public:
    ...
    // --------------------------------------------
    void Residual(const mjModel* model, const mjData* data, double* residual) const override;
    const ParticleXFixed* particle_fixed_task = nullptr;
  };
