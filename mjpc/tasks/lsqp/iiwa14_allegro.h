  ...
  public:
    ...
    mjModel* ConstructModel() override
    {
      ...
      const auto fCreateNumeric = [&scene_spec](const char* numeric_name, double value)
      {
        ...
        mjs_setString(numeric->info, numeric_name);
        numeric->size = 1;
      ...
      if constexpr (SYSTEM_MODEL_ACTUATORS_OSC)
      {
        ...
        for (auto i = 1; i <= IIWA14_DOF; i++)
        {
          ...
          {
            mjs_delete((mjSpec*)(act_spec), scene_spec->element);
          }
        }
      ...
      if (!key_home)
      {
        ...
        mjs_setString(key_home->info, "home");
      }
                                  ...
                                  float rgba[4] = nullptr)
      {
        ...
        mjs_setString(site->info, site_name.c_str());
        site->type = type;
      ...
      mjs_setString(ee_mocap->info, EETargetMocapName().data());
      ...
      for (const auto& fingertip : FINGERTIP_NAMES)
      {
        ...
        mjs_setString(finger_mocap->info, fingertip_target_name.c_str());
      ...
      if constexpr (SYSTEM_MODEL_ACTUATORS_OSC)
      {
                                                   ...
                                                   double gear[])
        {
          ...
          mjs_setString(act->info, actuator_name.c_str());
      ...
      reach_sensor->dim = 3;
      mjs_setString(reach_sensor->info, "Reach");
      ...
      mjs_setString(obj_pos_sensor->info, (std::string(TARGET_OBJ_NAME) + "_pos").c_str());
      ...
      mjs_setString(obj_quat_sensor->info, (std::string(TARGET_OBJ_NAME) + "_quat").c_str());
      ...
      mjs_setString(palm_sensor->info, (palm_site_name + "_pos").c_str());
      ...
      for (const auto& fingertip : FINGERTIP_NAMES)
      {
        ...
        mjs_setString(trace_sensor->info, (TRACE_SENSOR_PREFIX + std::to_string(trace_i++)).c_str());
        ...
        mjs_setString(framepos_sensor->info, (fingertip_name + "_pos").c_str());
        ...
        mjs_setString(framelinvel_sensor->info, (fingertip_name + "_lin_vel").c_str());
        ...
        mjs_setString(framelinacc_sensor->info, (fingertip_name + "_lin_acc").c_str());
        ...
        mjs_setString(frameangvel_sensor->info, (fingertip_name + "_ang_vel").c_str());
        ...
        mjs_setString(frameangacc_sensor->info, (fingertip_name + "_ang_acc").c_str());
      ...
      mjs_setString(ee_target_sensor->info, (ee_target_site_name + "_pos").c_str());
      ...
      mjs_setString(pick_obj->info, TARGET_OBJ_NAME);
