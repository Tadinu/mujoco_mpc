...
void InitializeProfiler(Simulate* sim) {
...
void UpdateProfiler(Simulate* sim) {
...
void ShowProfiler(Simulate* sim, mjrRect rect) {
  mjrRect viewport = {
...
// init sensor figure
void InitializeSensor(Simulate* sim) {
...
void UpdateSensor(Simulate* sim) {
  mjModel* m = sim->m;
  mjvFigure& figsensor = sim->figsensor;
...
// show sensor figure
void ShowSensor(Simulate* sim, mjrRect rect) {
...
// prepare info text
void UpdateInfoText(Simulate* sim,
                    char (&title)[Simulate::kMaxFilenameLength],
                    char (&content)[Simulate::kMaxFilenameLength],
...
void MakePhysicsSection(Simulate* sim, int oldstate) {
...
void MakeRenderingSection(Simulate* sim, int oldstate) {
...
void MakeGroupSection(Simulate* sim, int oldstate) {
...
void MakeJointSection(Simulate* sim, int oldstate) {
  mjuiDef defJoint[] = {
...
void MakeControlSection(Simulate* sim, int oldstate) {
  mjuiDef defControl[] = {
...
void MakeUiSections(Simulate* sim) {
...
void AlignAndScaleView(Simulate* sim) {
...
mjtNum Timer() {
  return Milliseconds(Simulate::Clock::now().time_since_epoch()).count();
}
...
void UpdateSettings(Simulate* sim) {
  // physics flags
  for (int i = 0; i < mjNDISABLE; i++) {
...
int UiPredicate(int category, void* userdata) {
  Simulate* sim = static_cast<Simulate*>(userdata);
...
void UiLayout(mjuiState* state) {
  Simulate* sim = static_cast<Simulate*>(state->userdata);
...
Simulate::Simulate(std::unique_ptr<mujoco::PlatformUIAdapter> platform_ui,
